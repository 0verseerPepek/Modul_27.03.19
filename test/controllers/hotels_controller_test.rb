...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { avatar: @hotel.avatar, description: @hotel.description } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { avatar: @hotel.avatar, description: @hotel.description } }
